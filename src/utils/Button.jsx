...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    secondary:
      'hover:text-stone-800 border-2 border-stone-300 inline-block rounded-full bg-transparent font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed px-4 py-2.5 md:px-6 md:py-3.5 focus:text-stone-800 text-sm',
  };
